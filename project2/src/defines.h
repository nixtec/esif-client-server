...
#define ACCEPTSESSION "0123456789-"
...
#else
#define ROOTDIR "/Users/ayub"  /* needed for edition initialization */
#endif
...
#define MAXFILENAME 30       /* maximum filename length */

#define FILENAMELEN 19
#define MINFILENAMELEN 15
#define MAXFILENAMELEN 25

/* information file header string pattern */
/* use sprintf() to build the pattern string */
/* M/F:Roll:Sec:totlist:group:sent:student_name */
#define HEADPATTERN "%s:%04d:%s:%04d:%s:%d:%s\n\n"
/* (char *)_(char *)_(int %0.4d).txt */
/* M/F_Roll_Sec_totlist_group.txt */
#define FILEPATTERN "%s_%04d_%s_%04d_%s.txt"
