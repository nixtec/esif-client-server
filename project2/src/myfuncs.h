...
void add_photo(GtkWidget *container);
...
/* all defined in myfuncs.c */
extern int ignore_fa_name;
extern int ignore_mo_name;
extern int ignore_birthdate;
extern int ignore_totlist;
extern int ignore_prev_year;
extern int ignore_prev_roll;
extern int ignore_prev_reg;
extern int ignore_prev_sess;
extern int ignore_photo;
/* ************************ */
...
extern int sess_inc; /* (main.c) examination_year = session_start + sess_inc */
